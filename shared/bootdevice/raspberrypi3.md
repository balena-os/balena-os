Insert the SD card into the {{ $device.name }} and connect either the ethernet cable if you want to connect via ethernet, otherwise the device will try connect via wifi. 
